...
HD_PWD='C:/Users/brand/OneDrive/Desktop/FPGA_Projects/Recorder/Recorder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log record_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source record_top.tcl
