...
HD_PWD='C:/Users/brand/OneDrive/Desktop/FPGA_Projects/Recorder/Recorder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log record_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source record_top.tcl -notrace
