...
HD_PWD='C:/Users/brand/OneDrive/Desktop/FPGA_Projects/Recorder/Recorder.runs/cic_compiler_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cic_compiler_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cic_compiler_0.tcl
