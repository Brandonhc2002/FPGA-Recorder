...
set_property -dict { PACKAGE_PIN J5    IOSTANDARD LVCMOS33 } [get_ports { microphone_clock }]; #IO_25_35 Sch=m_clk
set_property -dict { PACKAGE_PIN H5    IOSTANDARD LVCMOS33 } [get_ports { microphone_data }]; #IO_L24N_T3_35 Sch=m_data
set_property -dict { PACKAGE_PIN F5    IOSTANDARD LVCMOS33 } [get_ports { microphone_select }]; #IO_0_35 Sch=m_lrsel

#PWM Audio Amplifier
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { stereo }]; #IO_L4N_T0_15 Sch=aud_pwm
...
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { UART_TX_line  }]; #IO_L11N_T1_SRCC_35 Sch=uart_rxd_out
