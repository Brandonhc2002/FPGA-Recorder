...
#
# Script generated by Vivado on Sat Sep 13 17:01:41 -0500 2025
...
#
# Usage        : cic_compiler_0.sh
#                cic_compiler_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cic_compiler_0.sh [-reset_run]
#                cic_compiler_0.sh [-reset_log]
#                cic_compiler_0.sh [-help]
#
...
#                script (type 'cic_compiler_0.sh -help' for more information).
#
...
# script info
echo -e "cic_compiler_0.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cic_compiler_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/brand/OneDrive/Desktop/FPGA_Projects/Recorder/Recorder.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
...
Usage: cic_compiler_0.sh [-step]\n\
Usage: cic_compiler_0.sh [-lib_map_path]\n\
Usage: cic_compiler_0.sh [-reset_run]\n\
Usage: cic_compiler_0.sh [-reset_log]\n\
Usage: cic_compiler_0.sh [-keep_index]\n\
